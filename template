...
if tag == 'book': rating = raw_input("Rating: ")
header += '---' + '\n'
header +='title: ' + title + '\n'
...
write = raw_input('Write to file [ _posts/' + fn + ' ]? [y/n]: ')
if write == 'y':
    try:
        f = open('_posts/' + fn, 'a')
